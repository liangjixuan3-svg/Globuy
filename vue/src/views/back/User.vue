      ...
      <el-table :data="tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="认证状态" width="100" align="center">
          <template #default="scope">
            <el-tag v-if="scope.row.isAuth" type="success">已认证</el-tag>
      ...
      <el-form :model="form" label-width="100px">
        <el-form-item label="头像" required>
          <div class="upload-container">
            ...
            <el-upload :disabled="$demoMode" :action="`${serverHost}/web/upload`" :on-success="handleAvatarUrlUploadSuccess" :show-file-list="false">
        ...
        <el-form-item label="认证状态">
          <el-switch v-model="form.isAuth" active-text="已认证" inactive-text="未认证" />
        </el-form-item>
      </el-form>
      <template #footer>
