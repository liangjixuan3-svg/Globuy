      ...
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="图标上传">
          <div class="upload-container">
            <el-avatar v-if="form.icon" :src="form.icon" :size="80" shape="square"/>
            <el-upload :disabled="$demoMode" :action="`${serverHost}/web/upload`" :on-success="handleIconUploadSuccess" :show-file-list="false">
